...
export async function getServerSideProps({ res, query }) {
  ...
  const T = {
    en: {
      ...
      eDay:[['Morning','☕ Coffee on the terrace · 🍍 walk to the market for fresh fruit and fish'],['Afternoon','🌊 Beach 3 blocks away · 🚿 outdoor shower to rinse off'],['Evening','🦐 Seafood downstairs · 🍹 drinks across the street · 🔥 BBQ on your terrace']],
      ...
      lCards:[['Municipal market','5–10 min walk: fresh produce, fish market, local goods.'],['Regional transport','~30 m: buses to Punta de Mita, Bucerías, La Cruz. Sayulita connection depending on route.'],['No car needed','Beach, market, downtown, bar and laundry — all walkable.']],
    ...
    es: {
      ...
      eDay:[['Mañana','☕ Café en la terraza · 🍍 caminata al mercado por fruta y pescado fresco'],['Tarde','🌊 Playa a 3 cuadras · 🚿 regadera exterior para enjuagarte'],['Noche','🦐 Mariscos abajo · 🍹 una bebida enfrente · 🔥 BBQ en tu terraza']],
      ...
      lCards:[['Mercado municipal','5–10 minutos caminando: fruta, carnicería y pescadería fresca.'],['Transporte regional','~30 m: camiones a Punta de Mita, Bucerías, La Cruz. Conexión a Sayulita según ruta.'],['Sin coche, sin estrés','Comida, mercado, playa, bar y lavandería — todo caminando.']],
    ...
    fr: {
      ...
      eDay:[['Matin','☕ Café sur la terrasse · 🍍 balade au marché pour fruits frais et poisson'],['Après-midi','🌊 Plage à 3 blocs · 🚿 douche extérieure pour se rincer'],['Soir','🦐 Fruits de mer en bas · 🍹 verre en face · 🔥 BBQ sur votre terrasse']],
      ...
      lCards:[['Marché municipal','5–10 min à pied : fruits, boucherie et poissonnerie frais.'],['Transport régional','~30 m : bus vers Punta de Mita, Bucerías, La Cruz. Connexion Sayulita selon itinéraire.'],['Sans voiture, sans stress','Nourriture, marché, plage, bar et laverie — tout à pied.']],
